...
public class RCCP_EngineEditor : Editor {
    ...
    public override void OnInspectorGUI() {
        ...
        EditorGUILayout.PropertyField(serializedObject.FindProperty("engineAccelerationRate"), new GUIContent("Engine Acceleration Rate", "Engine acceleration rate."));
        EditorGUILayout.PropertyField(serializedObject.FindProperty("engineDecelerationRate"), new GUIContent("Engine Deceleration Rate", "Engine deceleration rate."));
        EditorGUILayout.Space();
