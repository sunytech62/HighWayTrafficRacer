...
public static class GameState
{
    ...
    public static int ChallengeLevelIndex;
    /*  public static int ChallengeLevelIndex
      {
          get => PlayerPrefs.GetInt("ChallengeLevelIndex", 0);
          set => PlayerPrefs.SetInt("ChallengeLevelIndex", value);
      }*/
    public static int ChallengeCompletedLevel
    {
        get => PlayerPrefs.GetInt("ChallengeCompletedLevel", 0);
